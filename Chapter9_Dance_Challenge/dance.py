# -*- coding: utf-8 -*-
"""
Created on Sun May 14 05:53:29 2023
...
def draw():  
    ...
    if not game_over:
        ...
        screen.draw.text("SONG: ROCK UR WORLD", color="black", topleft=(CENTER_X - 250, 255), fontsize=60)
...
def on_key_up(key):
    global score1, score2, game_over, move_list, current_move, secondplayer
...
def update():
    global game_over, current_move, moves_complete, secondplayer
    if not game_over:
...
secondplayer = 1
generate_moves()
music.play("knock2-rock-ur-world-_ft.-fussy.ogg")
pgzrun.go()
update()
